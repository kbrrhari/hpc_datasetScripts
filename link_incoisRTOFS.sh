...
do
  ...
  if ((10#$hr % 6 == 0))
  then
    ln -sf $source_dir/$yyyymmdd/022_archv.${yr}_${doy}_00.a rtofs_incois.t00z.f${hr}.archv.a 
...
do
  ...
  if ((10#$hr % 6 == 0))
  then
    ln -sf $source_dir/$yyyymmdd/022_archv.${yr}_${doy}_00.a rtofs_incois.t00z.n-${hr}.archv.a 
