...
source_dir="/incois_ncmrwfx/incois_tccsym/FORCING/kyarrMahaBulbul_IMD/incois_hycom_raw" 
# dt="2020-05-18"
dt=$1
...
dest_dir="/incois_ncmrwfx/incois_tccsym/FORCING/kyarrMahaBulbul_IMD/incois_hycom"
